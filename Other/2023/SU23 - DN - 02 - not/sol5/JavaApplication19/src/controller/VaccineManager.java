...
public class VaccineManager extends Menu {
    ...
    // Sort the list of vaccines by name
    public void sortVaccinesByName() {
        Collections.sort(vaccines, new Comparator<Vaccine>() {
            @Override
            public int compare(Vaccine vaccine1, Vaccine vaccine2) {
                return vaccine1.getName().compareToIgnoreCase(vaccine2.getName());
            }
        });
        System.out.println("List of vaccines sorted by name:");
    ...
    // Save the list of vaccines to a file
    public void saveVaccinesToFile(String filename) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filename))) {
            ...
            System.out.println("Vaccines saved to " + filename + " successfully.");
        } catch (IOException e) {
            System.out.println("Error: Failed to save vaccines to " + filename);
        }
    }
